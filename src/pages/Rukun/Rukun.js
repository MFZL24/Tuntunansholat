...
import { BacaanRukun, DefinisiRukun, HeaderRukun } from '../../assets/images/Rukun';
      ...
      <View style={styles.contentContainer}>
        <ImageBackground source={Icon} style={styles.IconImage}>
          <View style={styles.header}>
            <Image source={HeaderRukun} style={styles.headerImage} />
          </View>
          <View style={styles.imageContainer}>
            <Image source={DefinisiRukun} style={styles.image} />
          </View>

          <Image source={BacaanRukun} style={styles.imageTatacaraSholat} />
        ...
        <View style={styles.imageContainer}>
          <ImageBackground source={KotakNiat} style={styles.imageKotakNiat6}>
            ...
            <Text style={styles.Arabrukuk1}>اَللهُ أَكْبَرُ</Text>
            <Text style={styles.ArtiArabrukuk1}>Artinya: "Allah Maha Besar"</Text>
        ...
        <View style={styles.imageContainer}>
          <ImageBackground source={KotakNiat} style={styles.imageKotakNiat8}>
            ...
            <Text style={styles.ArabSujud12}>اَللهُ أَكْبَرُ</Text>
            <Text style={styles.ArtiArabSujud12}>Artinya: "Allah Maha Besar"</Text>
            ...
            <Text style={styles.ArabSujud21}>
              سُبْحَانَ رَبِّيَ الأَعْلَى وَبِحَمْدِهِ (3x)
            </Text>
            <Text style={styles.ArtiSujud21}>
        ...
        <View style={styles.imageContainer}>
          <ImageBackground source={KotakNiat} style={styles.imageKotakNiat9}>
            ...
            <Text style={styles.ArabTakbirADS}>اَللهُ أَكْبَرُ</Text>
            <Text style={styles.ArtiTakbirADS}>Artinya: "Allah Maha Besar"</Text>
        ...
        <View style={styles.imageContainer}>
          <ImageBackground source={KotakNiat} style={styles.imageKotakNiat10}>
            ...
            <Text style={styles.Arab42}>اَللهُ أَكْبَرُ</Text>
            <Text style={styles.ArtiArab42}>Artinya: "Allah Maha Besar"</Text>
...
const styles = StyleSheet.create({
  ...
  image: {
    width: wp('90%'), // Lebar 100% dari lebar layar saat ini
    height: hp('24%'), // Tinggi 20% dari tinggi layar saat ini
  },
  imageTatacaraSholat: {
    top: 30,
    width: wp('70%'), // Lebar 100% dari lebar layar saat ini
    height: hp('14%'), // Tinggi 20% dari tinggi layar saat ini
    right: -120,
  },
  imageRakaat1: {
    top: 10,
  ...
  //Niat
  imageKotakNiat: {
    width: wp('95%'), // Lebar 100% dari lebar layar saat ini
    height: hp('35%'), // Tinggi 20% dari tinggi layar saat ini
    top: 250,
    right: 0,
    left: 10,
    position: 'absolute',
  ...
  imageContainer2: {
    ...
    marginVertical: 700,
    width: wp('100%'), // Lebar 100% dari lebar layar saat ini
    height: hp('100%'), // Tinggi 20% dari tinggi layar saat ini
    position: 'absolute',
  },
  imageKotakNiat2: {
    width: '98%',
