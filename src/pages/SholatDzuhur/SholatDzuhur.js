...
import { DefinisiSholatDzuhur, HeaderSholatDzuhur, Icon, KotakNiat, Rakaat1, TatacaraSholat } from '../../assets/images';
      ...
      <View style={styles.contentContainer}>
        <ImageBackground source={Icon} style={styles.IconImage}>
          <View style={styles.header}>
            <Image source={HeaderSholatDzuhur} style={styles.headerImage} />
          </View>
          <View style={styles.imageContainer}>
            <Image source={DefinisiSholatDzuhur} style={styles.image} />
          </View>
