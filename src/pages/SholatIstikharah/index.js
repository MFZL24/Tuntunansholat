...
import {
  DefinisiSholatIstikharah,
  HeaderSholatIstikharah,
  IconPutih,
  KotakNiat,
  Rakaat1,
  TatacaraSholat
      ...
      <View style={styles.contentContainer}>
        <ImageBackground source={IconPutih} style={styles.IconImage}>
          <View style={styles.header}>
            <Image source={HeaderSholatIstikharah} style={styles.headerImage} />
          </View>
          <View style={styles.imageContainer}>
            <Image source={DefinisiSholatIstikharah} style={styles.image} />
          </View>
...
export default SholatIstikharah ;
