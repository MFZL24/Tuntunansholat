...
import {
  DefinisiSholatTahiyatulmesjid,
  HeaderSholatTahiyatulmesjid,
  IconPutih,
  KotakNiat,
  Rakaat1,
  TatacaraSholat
...
const SholatTahiyatulmesjid  = () => {
  return (
    <ScrollView style={styles.container} backgroundColor="#FFD700">
      <View style={styles.contentContainer}>
        <ImageBackground source={IconPutih} style={styles.IconImage}>
          <View style={styles.header}>
            <Image source={HeaderSholatTahiyatulmesjid} style={styles.headerImage} />
          </View>
          <View style={styles.imageContainer}>
            <Image source={DefinisiSholatTahiyatulmesjid} style={styles.image} />
          </View>
...
export default SholatTahiyatulmesjid;
